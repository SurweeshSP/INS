...
def test_best_accuracy_inference():
    print("Running test_best_accuracy_inference...")
    
    # 1. Generate a mock checkpoint to test inference without requiring a full training run
    ...
    mock_checkpoint = {
        ...
        "model_config": {"input_dim": 9, "num_classes": 5, "seq_len": 40},
        "input_features": 9,
        "window_length": 40,
        "sampling_rate": 10,
        "motion_classes": ["NORMAL_CRUISING", "BRAKING", "ACCELERATING", "STOPPED", "TURNING"],
    ...
    # 2. Import predict and run inference
    import inference
    ...
    print("test_best_accuracy_inference passed successfully!")

if __name__ == '__main__':
    test_best_accuracy_inference()
